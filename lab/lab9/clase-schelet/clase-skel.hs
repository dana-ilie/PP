...
instance Eq a => Eq (BST a) where
    (==) BSTNil BSTNil = True
    (==) (BSTNod info1 l1 r1) (BSTNod info2 l2 r2) = info1 == info2 && l1 == l2 && r1 == r2
    (==) _ _ = False
...
printLevel tab level (BSTNod root l r) = (replicate level tab) ++ (show root) ++ "\n"
...
instance Show a => Show (BST a) where
    show BSTNil = ""
    show (BSTNod root l r) = printLevel '\t' 0 (BSTNod root l r)
...
instance Invertible (BST a) where
    ...
    invert (BSTNod root l r) = (BSTNod root (invert r) (invert l))
...
instance Functor BST where
    ...
    fmap f (BSTNod root l r) = (BSTNod (f root) (fmap f l) (fmap f r))
...
instance Foldable BST where
    ...
    foldr f acc (BSTNod root l r) = foldr f (f root newAcc) l
        where newAcc = (foldr f acc r)
